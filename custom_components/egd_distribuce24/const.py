...
CONF_CREATE_CONSUMPTION_SENSORS = "create_consumption_sensors"
CONF_CREATE_PRODUCTION_SENSORS = "create_production_sensors"
...
DEFAULT_SCAN_INTERVAL = timedelta(hours=4) # Changed from 23 hours
DEFAULT_CREATE_CONSUMPTION_SENSORS = True
DEFAULT_CREATE_PRODUCTION_SENSORS = False
